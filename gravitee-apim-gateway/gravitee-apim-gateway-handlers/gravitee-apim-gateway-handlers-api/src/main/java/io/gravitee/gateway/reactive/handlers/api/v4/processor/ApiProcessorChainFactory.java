...
public class ApiProcessorChainFactory {
    ...
    public ApiProcessorChainFactory(final Configuration configuration, final Node node, final ReporterService reporterService, final CacheManager cacheManager) {
